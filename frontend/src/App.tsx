  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      ...
      <main id="top">
        ...
        <div className="mx-auto max-w-[1480px] px-4 pt-6 sm:px-6 lg:px-8"><div className="rounded-xl border border-cyan-500/30 bg-cyan-500/10 px-4 py-3 text-xs leading-5 text-cyan-900 dark:text-cyan-100" role="note"><strong>Prototype data policy:</strong> threat history is retained for {data?.storage?.retention_days ?? 90} days. Render Free uses an ephemeral filesystem, so local SQLite history resets after redeploys, restarts, or idle spin-down.</div></div>
